      ...
      function toggle(toggler, collapse) {
        ...
        if (element) {
          ...
          if (element.hasAttribute('data-focus-target') && !expanded) {
            var target = this.document.getElementById(element.getAttribute('data-focus-target'));
            if (target) {
              target.focus();
            }
          }
       ...
       */
       function collapseAll(exceptions) {
         var elements = this.document.querySelectorAll('[aria-expanded="true"]');
